defmodule MemoriesAndDiscoveriesSongBot do
  ...
  def songlist(date, from_time, to_time), do: IO.puts(FetchRadikoSongXml.fetch(Enum.join([date, from_time]), Enum.join([date, to_time])) |> ParseRadikoSongXml.parseAtristAndTitle)
